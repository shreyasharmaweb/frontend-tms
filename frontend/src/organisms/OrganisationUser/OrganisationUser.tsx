...
//   return (
//     <>
//         <h1 className='selectorg'>Select Any Organisation</h1>
//     <div className='orgus'>
...
import  { useEffect, useState } from 'react';
import { Modal, Button, ButtonToolbar, Content} from 'rsuite';
import {  useNavigate } from 'react-router-dom';
import Organisation from '../../services/OrganisationUserApi'
import './OrganisationsUser.style.scss'
...
export default function OrganisationUser() {
  ...
  return (
    <>
        <h1 style={{color:"black"}} className='selectorg'>Select Any Organisation</h1>
    <div className='orgus'>
      {org.map((e:EType, i:number) => (
        <div className='Org' key={i}>
          <h2 className='ho'>{e.name.toUpperCase()}</h2>
      ...
      {/* <div className='max-w-md mx-auto'> */}
          <form className='bg-white border rounded-lg shadow-md px-8 py-6 space-y-4' onSubmit={handleSubmit}>
            <div className='required'>
              <label className='block' htmlFor='email'>Email: <span style={{color:"red" }}>*</span></label>
            ...
            <div>
              <label className='block' htmlFor='firstName'>First Name: <span style={{color:"red" }}>*</span></label>
            ...
            <div>
              <label className='block' htmlFor='lastName'>Last Name:<span style={{color:"red" }}>*</span></label>
            ...
            <div>
              <label className='block' htmlFor='dob'>DOB:<span style={{color:"red" }}>*</span></label>
            ...
            <div>
              <label className='block' htmlFor='orgJoinDate'>Join Date:<span style={{color:"red" }}>*</span></label>
