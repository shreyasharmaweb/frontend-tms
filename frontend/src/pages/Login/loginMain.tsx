    ...
    <div className="main-container">
      <div className="flex flex-col justify-center items-center h-screen"> 
        ...
        <div className="login-box">
            <Login link="loginuser"  flag="true" user="Welcome! User" tagline="Welcome to our Task Management System! Log in to access your dashboard" fontColor="white" className='div' color="#9A639F"/>
          </div>
          <div className="login-box">
